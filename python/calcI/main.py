...
class ExponenteApp(MDApp):
    def build(self):
        ...
        layout = MDBoxLayout(
            ...
            spacing=10,
            padding=20,
            md_bg_color=get_color_from_hex("#000000")  # Fondo negro
        )

        self.exponenteEnt = TextInput(font_size=40, multiline=False, readonly=True, halign="center", background_color=(1, 1, 1, 1))
        
        button_layout = GridLayout(cols=3, spacing=10, size_hint_y=None, height=300)
    ...
    def calculate_result(self, instance):
        try:
            ...
            print("Error:", e)  # Imprimir detalles del error
            self.exponenteEnt.text = "Error"

        # Programar la eliminación del contenido después de 3 segundos
        Clock.schedule_once(self.clearTextAfterDelay, 3)

    def clearTextAfterDelay(self, dt=""):
        self.exponenteEnt.text = ""  # Limpia el campo de texto
